...
execute @s[scores={seconds=2}] ~ ~ ~ scoreboard players random @s qid 1 10
#Display the question and question number
execute @s[scores={seconds=2}] ~ ~ ~ title @a times 20 140 20
execute @s[scores={seconds=2}] ~ ~ ~ function question/show
execute @s[scores={seconds=2}] ~ ~ ~ function question/shownumber



execute @s[scores={seconds=10}] ~ ~ ~ replaceitem entity @a slot.armor.head 1 air 1
execute @s[scores={seconds=10}] ~ ~ ~ function question/answermc
